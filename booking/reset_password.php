...
<div class="container">
    ...
    <form id="resetForm" method="POST" action="reset_password">
        ...
        <div class="input-group">
            <input type="password" id="new_password" name="new_password" minlength="8" maxlength="12"  pattern="^(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*])[A-Za-z\d!@#$%^&*]{8,}$" title="Password must be at least 8 characters long, contain at least one uppercase letter, one number, and one special character." required placeholder="New Password">
            <i class="far fa-eye" id="new_password_toggle"></i>
        </div>
        <label for="confirm_password">Confirm your new password:</label>
        <div class="input-group">
            <input type="password" id="confirm_password" name="confirm_password" minlength="8" maxlength="12"  pattern="^(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*])[A-Za-z\d!@#$%^&*]{8,}$" title="Password must be at least 8 characters long, contain at least one uppercase letter, one number, and one special character." required placeholder="Confirm Password">
