  ...
  <div class="row">
    ...
    <!-- Second Column -->
      ...
      <div class="form-group">
        ...
        <input name="zip" type="number" class="form-control input-sm" id="zip" maxlength="4" required oninput="this.value = this.value.replace(/\D/, ''); if(this.value.length > 4) this.value = this.value.slice(0, 4);">
      </div>
