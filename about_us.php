    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="container" style="text-align: center;">
          <iframe frameborder="0" style="width: 95%; height: 400px; text-align: center;" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=Madridejos%20Community%20College&#038;t=m&#038;z=16&#038;output=embed&#038;iwloc=near" title="Madridejos Community College" aria-label="Madridejos Community College"></iframe>
        </div>
      </div>
      <div class="col-md-4">
       <h3>Contact Info</h3>
       <div class="space"></div>
              ...
              <div class="space"></div>
              <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i><span class="link-text" onclick="window.location.href='mailto:Hmhotel@gmail.com';">mcchmhotelreservation@gmail.com</span></p>
              <div class="space"></div>
