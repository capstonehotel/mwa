...
<div class="col-xl-4 col-md-6 mb-4">
    <div class="card border-left-dark shadow h-100 py-2" style="border-color: #800000;">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-maroon text-uppercase mb-1" style="color: #800000;">
                        Rooms</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo isset($result->Total) ? $result->Total : 0;?></div>
                </div>
                <div class="col-auto">
                    <i class="fas fa-bed fa-2x" style="color: #FF6666;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-left-dark shadow h-100 py-2" style="border-color: #800000;">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-auto">
                    <i class="fas fa-book fa-2x" style="color: #FF6666;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-left-dark shadow h-100 py-2" style="border-color: #800000;">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-auto">
                    <i class="fa fa-times fa-2x" style="color: #FF6666;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-left-dark shadow h-100 py-2" style="border-color: #800000;">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-auto">
                    <i class="fa fa-calendar fa-2x" style="color: #FF6666;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-left-dark shadow h-100 py-2" style="border-color: #800000;">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-auto">
                    <i class="fas fa-check fa-2x" style="color: #FF6666;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card border-left-dark shadow h-100 py-2" style="border-color: #800000;">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-auto">
                    <i class="fas fa-user fa-2x" style="color: #FF6666;"></i>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-xl-8 col-lg-7">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background-color: #800000;">
            <h6 class="m-0 font-weight-bold text-light">Graph</h6>
        </div>
        <div class="card-body">
...
var barColors = ["#CD5C5C", "#800000", "#D8BFD8", "#FF6666", "#F08080"];
